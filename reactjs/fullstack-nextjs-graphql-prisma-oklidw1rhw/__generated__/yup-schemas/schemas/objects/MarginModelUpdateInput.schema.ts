...
import { HardwareUpdateManyWithoutSellMarginModelNestedInputObjectSchema } from "../internals";

export const MarginModelUpdateInputObjectSchema = Yup.object({
  ...
  hardware: HardwareUpdateManyWithoutSellMarginModelNestedInputObjectSchema,
});
