...
import { UserUncheckedUpdateManyWithoutBookmarksNestedInputObjectSchema } from "../internals";

export const LinkUncheckedUpdateInputObjectSchema = Yup.object({
  ...
  users: UserUncheckedUpdateManyWithoutBookmarksNestedInputObjectSchema,
});
