...
export const NestedFloatNullableWithAggregatesFilterObjectSchema = Yup.object({
  ...
  not: Yup.mixed().oneOfSchemas([
    Yup.number(),
    Yup.lazy(() =>
      NestedFloatNullableWithAggregatesFilterObjectSchema.default(undefined)
    ),
  ]),
  _count: NestedIntNullableFilterObjectSchema,
  _avg: NestedFloatNullableFilterObjectSchema,
  _sum: NestedFloatNullableFilterObjectSchema,
  _min: NestedFloatNullableFilterObjectSchema,
  _max: NestedFloatNullableFilterObjectSchema,
});
