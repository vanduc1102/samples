...
import { HardwareUncheckedUpdateManyWithoutSellMarginModelNestedInputObjectSchema } from "../internals";

export const MarginModelUncheckedUpdateInputObjectSchema = Yup.object({
  ...
  hardware:
    HardwareUncheckedUpdateManyWithoutSellMarginModelNestedInputObjectSchema,
});
