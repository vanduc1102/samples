...
import { HardwareCreateNestedManyWithoutSellMarginModelInputObjectSchema } from "../internals";

export const MarginModelCreateInputObjectSchema = Yup.object({
  createdAt: Yup.date(),
  updatedAt: Yup.date(),
  ...
  hardware: HardwareCreateNestedManyWithoutSellMarginModelInputObjectSchema,
});
