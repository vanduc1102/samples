...
import { MarginModelOrderByWithRelationInputObjectSchema } from "../internals";

export const HardwareOrderByWithRelationInputObjectSchema = Yup.object({
  id: SortOrderSchema,
  ...
  sellMarginModel: MarginModelOrderByWithRelationInputObjectSchema,
});
