...
import { MarginModelRelationFilterObjectSchema } from "../internals";
import { MarginModelWhereInputObjectSchema } from "../internals";

export const HardwareWhereInputObjectSchema = Yup.object({
  AND: Yup.mixed().oneOfSchemas([
    Yup.lazy(() => HardwareWhereInputObjectSchema.default(undefined)),
    Yup.array().of(
      Yup.lazy(() => HardwareWhereInputObjectSchema.default(undefined))
    ),
  ]),
  ...
  sellMarginModel: Yup.mixed().oneOfSchemas([
    MarginModelRelationFilterObjectSchema,
