...
import { MarginModelUpdateOneRequiredWithoutHardwareNestedInputObjectSchema } from "../internals";

export const HardwareUpdateInputObjectSchema = Yup.object({
  ...
  sellMarginModel:
    MarginModelUpdateOneRequiredWithoutHardwareNestedInputObjectSchema,
});
